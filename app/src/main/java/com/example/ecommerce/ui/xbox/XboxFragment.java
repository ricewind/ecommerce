...
public class XboxFragment extends Fragment implements MyRecyclerViewAdapter.ItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        XboxViewModel = new ViewModelProvider(this).get(XboxViewModel.class);
        ...
        RecyclerView recyclerView = root.findViewById(R.id.dataXbox);
